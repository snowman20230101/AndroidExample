...
#ifndef ANDROIDEXAMPLE_IMAGEDEF_H
#define ANDROIDEXAMPLE_IMAGEDEF_H
...
public:
    ...
    static void CopyNativeImage(NativeImage *pSrcImg, NativeImage *pDstImg) {
        LOGE("NativeImageUtil::CopyNativeImage src[w,h,format]=[%d, %d, %d], dst[w,h,format]=[%d, %d, %d]",
             pSrcImg->width, pSrcImg->height, pSrcImg->format, pDstImg->width, pDstImg->height,
             pDstImg->format);
        LOGE("NativeImageUtil::CopyNativeImage src[line0,line1,line2]=[%d, %d, %d], dst[line0,line1,line2]=[%d, %d, %d]",
...
#endif //ANDROIDEXAMPLE_IMAGEDEF_H
